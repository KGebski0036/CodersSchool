...
class MaxOfVectorTestFixture : public ::testing::TestWithParam<std::tuple<std::vector<int>,
	int>>
{};
...
INSTANTIATE_TEST_SUITE_P(MaxOfVectorTests, MaxOfVectorTestFixture,
	::testing::Values(std::make_tuple(std::vector<int>{0}, 0),
